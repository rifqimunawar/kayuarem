...
5. Memberdayakan masyarakat sekitar dengan membuka lapangan kerja dan pelatihan keterampilan berbasis industri kayu.',
                ...
                'deskripsi_slogan' => '{"en":"Arem wood is a craft brand that presents unique products from selected wood, combined with modern industrial materials such as acrylic, ACP, leather, and others. With the support of CNC Router and Laser engine technology, each product is processed precisely, then enhanced by experienced experts to produce the best quality. We produce various needs ranging from home decor, wooden bags, educational toys, to equipment for cafes, restaurants and hotels. More than just a brand, arem wood is also committed to empowering labor from the surrounding environment, so that each work has social value as well as aesthetic.","id":"Kayu Arem adalah brand kerajinan yang menghadirkan produk-produk unik dari kayu pilihan, dikombinasikan dengan bahan industrial modern seperti akrilik, ACP, kulit, dan lainnya. Dengan dukungan teknologi mesin CNC router dan laser, setiap produk diproses secara presisi, lalu disempurnakan oleh tenaga ahli berpengalaman agar menghasilkan kualitas terbaik. Kami memproduksi berbagai kebutuhan mulai dari home decor, tas kayu,mainan edukatif, hingga perlengkapan untuk kafe, restoran, dan hotel. Lebih dari sekadar brand, Kayu Arem juga berkomitmen untuk memberdayakan tenaga kerja dari lingkungan sekitar, sehingga setiap karya memiliki nilai sosial sekaligus estetika."}',
                'deleted_at' => NULL,
                'created_at' => NULL,
                'updated_at' => '2025-09-27 15:08:57',
            ),
        ));
