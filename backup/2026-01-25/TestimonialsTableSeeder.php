    ...
    public function run()
    {
        ...
        \DB::table('testimonials')->insert(array (
            ...
            array (
                ...
                'updated_at' => '2025-09-30 21:01:33',
            ),
            3 => 
            array (
                'id' => 4,
                ...
                'jk' => '0',
                'profesi' => NULL,
                'deskripsi' => '{"id":"Luar biasa produknya, tidak hanya menggunakan material yang berkualitas, tetapi juga merepresantasikan keindahan kearifan lokal","en":"Incredible products, not only use quality materials, but also represent the beauty of local wisdom"}',
                'deleted_at' => '2025-10-09 19:08:23',
                'created_at' => '2025-10-01 07:48:59',
                'updated_at' => '2025-10-09 19:08:23',
            ),
        ));
