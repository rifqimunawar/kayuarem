...
@section('content-client')
  ...
  <div class="container-fluid page-header py-5 mb-5">
    <div class="container py-5">
      <h1 class="display-3 text-white mb-3 animated slideInDown">{{ __('trans.About Us') }}</h1>
      <nav aria-label="breadcrumb animated slideInDown">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item text-white active" aria-current="page">{{ __('trans.About') }}</li>
        </ol>
      </nav>
    </div>
  </div>
