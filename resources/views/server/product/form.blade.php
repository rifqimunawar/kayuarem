          ...
          <div class="row">
            ...
            <div class="col-md-12 mb-3">
              <label for="nama_produk" class="form-label">
                Nama Prodcut <span class="text-danger">*</span>
              </label>
            ...
            <div class="col-md-12 mb-3">
              ...
              <input type="text" class="form-control format-rupiah-input @error('nominal') is-invalid @enderror"
            ...
            <!-- Category Field -->
            <div class="col-md-12 mb-3">
              <label for="categori_id" class="form-label">
                Category <span class="text-danger">*</span>
              </label>
              <select class="form-select @error('categori_id') is-invalid @enderror" id="categori_id" name="categori_id"
                required>
                <option value="" disabled selected>-- Pilih Category --</option>
                @foreach ($dataCategory as $item)
                <option value="{{ $item->id }}" {{ old('categori_id', $data->categori_id ?? '') == $item->id ?
                  'selected' : '' }}>
                  {{ $item->categori }}
                </option>
                @endforeach
            ...
            <div class="col-md-12 mb-3">
              ...
              <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi"
                rows="5" placeholder="Masukkan deskripsi..."
