      ...
      <div class="card w-100">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
              <a href="{{ route('create.testimonial') }}" class="btn btn-primary "> <i class="bi bi-plus-lg"></i>
                Tambah</a>
            </div>
          </div>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <div class="btn-group" role="group">
                        <!-- Show Button -->
                        <a href="{{ route('show.testimonial', $item->id) }}" class="btn btn-sm btn-outline-success"><i
                            class="bi bi-eye" style="font-size: 14px"></i></a>

                        <!-- Edit Button -->
                        <a href="{{ route('edit.testimonial', $item->id) }}" class="btn btn-sm btn-outline-warning"><i
                            class="bi bi-pencil-square" style="font-size: 14px"></i></a>

                        <!-- Delete Button -->
                        <a href="{{ route('delete.testimonial', $item->id) }}" title="Hapus Data"
