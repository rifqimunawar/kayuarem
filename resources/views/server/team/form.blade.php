          ...
          <div class="row">
            <div class="col-md-12 mb-3">
              ...
              <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama"
                value="{{ old('nama', $data->nama ?? '') }}" placeholder="Masukkan nama..." required>
              @error('nama')
            ...
            <div class="col-md-12 mb-3">
              ...
              <input type="text" class="form-control @error('posisi') is-invalid @enderror" id="posisi" name="posisi"
                value="{{ old('posisi', $data->posisi ?? '') }}" placeholder="Masukkan posisi..." required>
              @error('posisi')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
            ...
            <div class="col-md-12 mb-3">
              <label for="link_ig" class="form-label">
                Link Instagram <span class="text-danger">*</span>
              </label>
              <input type="text" class="form-control @error('link_ig') is-invalid @enderror" id="link_ig" name="link_ig"
                value="{{ old('link_ig', $data->link_ig ?? '') }}" placeholder="Masukkan link_ig..." required>
              @error('link_ig')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
