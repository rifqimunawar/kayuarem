    ...
    <div class="card w-100">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
          ...
          <div>
            <a href="{{ route('create.team') }}" class="btn btn-primary "> <i class="bi bi-plus-lg"></i>
              Tambah</a>
          </div>
        </div>
          ...
          <table id="dataTable" class="table table-hover table-striped">
            <thead class="table-dark">
              <tr>
                ...
                <th scope="col" style="width: 15%">Posisi</th>
              ...
              <tr>
                ...
                <td class="text-center">
                  <div class="btn-group" role="group">
                    <!-- Edit Button -->
                    <a href="{{ route('edit.team', $item->id) }}" class="btn btn-sm btn-outline-warning"><i
                        class="bi bi-pencil-square" style="font-size: 14px"></i></a>

                    <!-- Delete Button -->
                    <a href="{{ route('delete.team', $item->id) }}" title="Hapus Data"
