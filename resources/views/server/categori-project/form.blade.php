    ...
    <div class="col-lg-12">
      <div class="card w-100">
        <div class="card-body">
          ...
          <!-- Form -->
          <form action="{{ route('store.categoriProject') }}" method="POST" id="form" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
              ...
              <div class="col-md-12 mb-3">
                ...
                <input type="text" class="form-control @error('categori') is-invalid @enderror" id="categori"
                  name="categori" value="{{ old('categori', $data->categori ?? '') }}" placeholder="Masukkan categori..."
                  required>
                @error('categori')
