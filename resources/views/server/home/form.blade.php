        ...
        <form action="{{ route('store.home') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-md-12 mb-3">
              ...
              <input type="text" class="form-control @error('slogan') is-invalid @enderror" id="slogan" name="slogan"
                value="{{ old('slogan', $data->slogan ?? '') }}" placeholder="Masukkan slogan..." required>
              @error('slogan')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
