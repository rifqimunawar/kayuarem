            ...
            <div class="row">
              ...
              <div class="col-md-12 mb-3">
                ...
                <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul"
                  name="judul" value="{{ old('judul', $data->judul ?? '') }}" placeholder="Masukkan judul news..."
                  required>
                @error('judul')
                ...
                <select class="form-select @error('categori_id') is-invalid @enderror" id="categori_id" name="categori_id"
                  ...
                  @foreach ($dataCategory as $item)
                    <option value="{{ $item->id }}"
                      {{ old('categori_id', $data->categori_id ?? '') == $item->id ? 'selected' : '' }}>
                      {{ $item->categori }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="col-md-12 mb-3">
                ...
                <textarea id="summernote" class="form-control" name="deskripsi" rows="5" placeholder="Masukkan deskripsi..."
