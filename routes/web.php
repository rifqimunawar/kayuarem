...
use App\Http\Controllers\Server\UserManagementCont;
...
Route::post('login', [AuthController::class, 'loginStore'])
  ->name('login.store')
  ->middleware('guest');
Route::post('api/login', [AuthController::class, 'loginStore'])
  ->name('api.login')
...
Route::middleware(['auth'])->group(function () {
  ...
  Route::get('/admin/user-management', [UserManagementCont::class, 'index'])->name('index.user-management');
  Route::get('/admin/user-management/create', [UserManagementCont::class, 'create'])->name('create.user-management');
  Route::get('/admin/user-management/{id}/edit', [UserManagementCont::class, 'edit'])->name('edit.user-management');
